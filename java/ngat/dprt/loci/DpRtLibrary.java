 ...
 * FITS file data reduction, for the LOCI Control System.
...
// DpRt.h
	...
	/**
	 * Static code to load libdprt_loci, the shared C library that implements an the real time data reduction.
	 */
	static
	{
		System.loadLibrary("dprt_loci");
	}
