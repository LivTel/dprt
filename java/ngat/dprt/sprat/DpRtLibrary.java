// DpRtLibrary.java
// $Header: /space/home/eng/cjm/cvs/dprt/java/ngat/dprt/sprat/DpRtLibrary.java,v 1.1 2014-08-01 10:41:22 cjm Exp $
package ngat.dprt.sprat;
 ...
 * FITS file data reduction, for the Sprat Control System.
...
public class DpRtLibrary implements DpRtLibraryInterface
{
	 ...
	 */
	public final static String RCSID = new String("$Id: DpRtLibrary.java,v 1.1 2014-08-01 10:41:22 cjm Exp $");
	/**
...
// DpRt.h
	...
	/**
	 * Static code to load libdprt_sprat, the shared C library that implements an the real time data reduction.
	 */
	static
	{
		System.loadLibrary("dprt_sprat");
	}
