...
*/
// DpRtLibrary.java
// $Header: /space/home/eng/cjm/cvs/dprt/java/ngat/dprt/rise/DpRtLibrary.java,v 1.1 2011-11-23 11:08:37 cjm Exp $
package ngat.dprt.rise;
 ...
 * FITS file data reduction, for the RISE Control System (rise).
...
public class DpRtLibrary implements DpRtLibraryInterface
{
	 ...
	 */
	public final static String RCSID = new String("$Id: DpRtLibrary.java,v 1.1 2011-11-23 11:08:37 cjm Exp $");
	/**
...
// DpRt.h
	...
	/**
	 * Static code to load libdprt_rise, the shared C library that implements an the real time data reduction.
	 */
	static
	{
		System.loadLibrary("dprt_rise");
	}
